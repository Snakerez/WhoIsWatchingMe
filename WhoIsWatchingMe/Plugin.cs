...
namespace WhoIsWatchingMe
{
    ...
    {
        public string Name => "WhoIsWatchingMe";
        ...
        private const string CommandName3 = "/wiwmconfig";
        ...
        public readonly WindowSystem WindowSystem = new("Who Is Watching Me?");
        ...
        public Plugin()
        {
            ...
            {
                HelpMessage = "Opens Who is watching me Window."
            });
            ...
            {
                HelpMessage = "Opens Who is watching me Config."
            });
        ...
        public void DrawConfig() => OnConfig("/wiwmconfig", "");
        private void DrawMain() => OnCommand("/wiwm", "");
