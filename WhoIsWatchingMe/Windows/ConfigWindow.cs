...
namespace WhoIsWatchingMe.Windows
{
    public class ConfigWindow : Window, IDisposable
    {
        ...
        public ConfigWindow(Plugin plugin) : base("WhoIsWatching Settings")
        {
        ...
        public override void Draw()
        {
            ...
            {
                GenericHelpers.ShellStart("https://discord.gg/GxcYfQyKSM");
            }
            ...
            if (ImGui.BeginTabBar("##ConfigTabs"))
            {
                ...
                if (ImGui.BeginTabItem("Colors"))
                {
                    ...
                    if (ImGui.IsItemHovered())
                    {
                        ImGui.SetTooltip("Color used when the target is Watching.");
                    }
                    ...
                    if (ImGui.IsItemHovered())
                    {
                        ImGui.SetTooltip("Color used for recently loaded/Watching targets.");
                    }
                    ...
                    if (ImGui.IsItemHovered())
                    {
                        ImGui.SetTooltip("Color used for Watchers that are currently not loaded.");
                    }
                ...
                {
                    ImGui.Spacing();
                    ImGui.TextColored(new Vector4(1.0f, 0.8f, 0.8f, 1.0f), "About WhoIsWatchingMe");
                    ImGui.Separator();
                    ImGui.Spacing();

                    ImGui.Text("WhoIsWatching");
                    ImGui.Spacing();
                    ImGui.Text($"Version: {Configuration.DevVersion}");
                    ImGui.Text("Author: ThaMimi");
                    ...
                    if (ImGui.Button("Join Server"))
                    {
                        try
                        {
                            Util.OpenLink("https://discord.gg/GxcYfQyKSM");
                        }
                        catch (Exception ex)
                        {
                        }
                    ...
                    ImGui.Spacing();
                    ImGui.TextWrapped("Description: A slightly different version of Peeping Tom, offering More QOL.");
