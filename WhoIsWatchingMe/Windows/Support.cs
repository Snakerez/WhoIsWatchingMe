...
namespace WhoIsWatchingMe.Windows
{
    public static class Support
    {
        ...
        {
            Click = (m) => { GenericHelpers.ShellStart("https://ko-fi.com/thamimiff"); },
        ...
        public static string DonateLink => "https://ko-fi.com/thamimiff";
        ...
        private static void Popup()
        {
            ...
            if (ImGui.BeginPopup("NXPS"))
            {
                ...
                {
                    GenericHelpers.ShellStart("https://ko-fi.com/thamimiff");
                }
